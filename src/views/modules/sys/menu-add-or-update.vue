<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item v-if="dataForm.type == 0" label="导航菜单" prop="perms">
        <el-radio-group v-model="dataForm.navType">
          <el-radio v-for="(type, index) in dataForm.navList" :label="index" :key="index">{{ type }}</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              this.dataForm.navType = data.menu.navType
              this.menuListTreeSetCurrentNode()
            })
          }
        })
